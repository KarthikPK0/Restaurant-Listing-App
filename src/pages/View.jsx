        ...
        <div className="row">
            ...
            <div className="col col2" style={{paddingBottom:'30px'}}>
                ...
                <div className="buttons">
                 <button onClick={handleShow} style={{width:'180px',margin:'15px 0 15px 0'}} className='btn btn-light rounded'>
                    Operating Hours
                   </button>

                   <button onClick={()=>setDisplay(!display)} style={{width:'280px'}} className='btn btn-light rounded'>
